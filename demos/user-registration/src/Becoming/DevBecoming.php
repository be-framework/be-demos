...
namespace Be\Pattern\UserRegistration\Becoming;
...
final class DevBecoming implements BecomingInterface
{
    ...
    public function __invoke(object $input): object
    {
        try {
            ...
            file_put_contents(
                $dir . '/user-registration.json',
                json_encode($this->logger->flush(), JSON_PRETTY_PRINT | JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE),
            );
        }
    }
}
